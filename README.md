...
<!-- [![GitHub tag](https://badgen.net/github/tag/echasnovski/mini.pairs)](https://github.com/echasnovski/mini.pairs/tags/) -->
<!-- [![Current version](https://badgen.net/badge/Current%20version/development/cyan)](https://github.com/echasnovski/mini.pairs/blob/main/CHANGELOG.md) -->
<!-- badges: end -->

**Minimal and fast autopairs**

See more details in [help file](doc/mini-pairs.txt).
...
<table>
    ...
    <tbody>
        ...
        <!-- <tr> -->
        <!--     <td rowspan=2>Standalone plugin</td> <td>Main</td> <td><code>use 'echasnovski/mini.pairs'</code></td> -->
        <!-- </tr> -->
        <!-- <tr> -->
        <!--     <td>Stable</td> <td><code>use { 'echasnovski/mini.pairs', branch = 'stable' }</code></td> -->
        <!-- </tr> -->
    </tbody>
</table>
